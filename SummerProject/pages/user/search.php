                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        if (isset($_GET['search'])) {
                            ...
                            $search = '%' . $search . '%';
                            $sql = "SELECT * FROM all_items WHERE (item LIKE ? OR description LIKE ?) AND collected=? AND item IN (select Item from `item_lost` where UID=? )";
                            $collected=0;
                            $stmt = $conn->prepare($sql);
                            $stmt->bind_param("ssii", $search, $search, $collected,$_SESSION['user_id']);
                            $stmt->execute();
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <div class="col-md-4 grid-margin ">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <img src="<?php echo $targetPath; ?>" class="card-img-top figure-img img-fluid rounded img-thumbnail"
                                                alt="No image found" style="width: 300px; height: 200px;">
                                ...
                                echo "<div class='col grid-margin'>Search Result: No Data Found</div>";
                            }                        
                        ?>
                </div>
            </div>
